...
CREATE TABLE "model_order" ("id"	INTEGER NOT NULL,"model_id"	INTEGER NOT NULL,"qtty"	INTEGER NOT NULL,"price"	REAL NOT NULL,"order_id"	INTEGER NOT NULL,FOREIGN KEY("order_id") REFERENCES "orders"("id"),PRIMARY KEY("id" AUTOINCREMENT),FOREIGN KEY("model_id") REFERENCES "model"("id"));
