...
CREATE TABLE "model_user" ("id"	INTEGER NOT NULL,"model_id"	INTEGER NOT NULL,"state" INTEGER NOT NULL,"start_time" varchar(10), "end_time" varchar(10),FOREIGN KEY("model_id") REFERENCES "model"("id"),FOREIGN KEY("state") REFERENCES "status"("id"),PRIMARY KEY("id" AUTOINCREMENT));
