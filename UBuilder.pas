...
var
  ...
  name, query: String;
begin
  idCountry := DBLCBBuilderCountry.ListSource.DataSet.FieldByName('id')
    .AsInteger;
...
begin
  ...
  BBuilderAdd.Enabled := (newName.Length > 0) and
    (DBLCBBuilderCountry.Text.Length > 0);
end;
...
begin
  EBuilderUpdateName.Text := DBGBuilder.DataSource.DataSet.FieldByName
    ('nom').AsString;
end;
